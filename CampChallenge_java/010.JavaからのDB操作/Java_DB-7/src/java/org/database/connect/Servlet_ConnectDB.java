            ...
            throws ServletException, IOException 
    {
        ...
        */
        ...
        try
        {
            ...
            String[] sql ={"update profiles set name = '松岡 修造' where profilesID = 1;",
                           "update profiles set age = 48 where profilesID = 1;",
                           "update profiles set birthday = '1967-11-06' where profilesID = 1;"};
            
            for(int i = 0; i<3;i++)
            {
                db_st = db_con.prepareStatement(sql[i]);
                int num = db_st.executeUpdate();
            
            }
            
            sql[0] = "select * from profiles;";
            db_st = db_con.prepareStatement(sql[0]);
