...
public class speachTest extends HttpServlet {
     ...
     * 課題：課題「ユーザー定義メソッドの作成」で定義したメソッドに追記する形として、
     * 戻り値　true(boolean)　を返却するように修正し、メソッドの呼び出し側でtrueを受け取れたら
     * 「この処理は正しく実行できました」、そうでないなら「正しく実行できませんでした」と表示する
     */
    ...
    public boolean showProfile(PrintWriter out,methodTest Data) 
    {
