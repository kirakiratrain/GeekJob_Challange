...
//            UserDataDTO serchData = (UserDataDTO)request.getAttribute("resultData");
//            updateData.setUserID(serchData.getUserID());
            
            UserDataDTO resultData = UserDataDAO .getInstance().updateDataAll(updateData);
