...
public class InsertResult extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try
        {
            ...
            //タスク6
            String birthday = (String)session.getAttribute("year") + "/" 
                                + (String)session.getAttribute("month") + "/" 
                                + (String)session.getAttribute("day");
            birthday += " 00:00:00";
            java.util.Date dateBirthday = DateUtil.toDate(birthday);
            //Calendar birthday = Calendar.getInstance();       //タスク6のためコメントアウト
            userdata.setBirthday(dateBirthday);
